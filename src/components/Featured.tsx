    ...
    <section className="py-24 px-6 bg-deep-green text-cream overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Chook Favorites</h2>
            <p className="text-cream/60 max-w-md">
              Experience our most beloved creations, from traditional Omani coffee to our signature Shakshuka.
            </p>
          </div>
