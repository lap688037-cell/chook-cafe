    ...
    <section className="py-24 px-6 bg-white/50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-deep-green mb-8">Visit Chook Cafe</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-deep-green/60">Daily: 8:00 AM - 11:00 PM<br />Muscat Time</p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-deep-green/60">+968 9117 8110<br />hello@chookcafe.com</p>
                </div>
              </div>
            </div>
