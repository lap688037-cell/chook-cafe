      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-bold text-deep-green leading-tight mb-6 text-balance">
            Chook Cafe.<br />
            <span className="text-sage">It's a Vibe.</span>
          </h1>
          <p className="text-lg md:text-xl text-deep-green/70 mb-10 max-w-lg">
            Indulge in popular Omani and International cuisines. 
            The modernized cafe that takes forward the legacy of Omani coffee shops.
          </p>
